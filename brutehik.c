...
#define PASSWORD_LENGTH 100 // Определяем длину пароля
...
int main() {
    char target_ip[64];
    int target_port = 554; // Порт по умолчанию для RTSP
    char username[100];
